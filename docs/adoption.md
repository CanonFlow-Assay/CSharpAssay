...
Install exact version `0.1.0`, copy `eng/templates/observe.csassay.json`, and
run provisional observation:

```text
dotnet tool install --local CsAssay.Tool --version 0.1.0
...
listed as required rules and cannot fail a release in `0.1.0`.
